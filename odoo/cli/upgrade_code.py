    ...
    class Command:
        ...
        def parser(self):
            return argparse.ArgumentParser(
                ...
                description=__doc__.replace('/erpbizz/upgrade_code', str(UPGRADE)),
...
class UpgradeCode(Command):
    """ Rewrite the entire source code using the scripts found at /erpbizz/upgrade_code """
    name = 'upgrade_code'
