...
class TestAddonPaths(TransactionCase):
    def test_operations(self):
        ...
        asset_paths.append([
            ('/home/user/erpbizz/addons/web/a', '/web/a', 1),
            ('/home/user/erpbizz/addons/web/c', '/web/c', 1),
            ('/home/user/erpbizz/addons/web/d', '/web/d', 1),
        ], 'bundle1')
        self.assertEqual(asset_paths.list, [
            ('/home/user/erpbizz/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/d', '/web/d', 'bundle1', 1),
        ])

        # append with a duplicate of 'c'
        asset_paths.append([
            ('/home/user/erpbizz/addons/web/c', '/web/c', 1),
            ('/home/user/erpbizz/addons/web/f', '/web/f', 1),
        ], 'bundle2')
        self.assertEqual(asset_paths.list, [
            ('/home/user/erpbizz/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'c' after 'c'
        asset_paths.insert([
            ('/home/user/erpbizz/addons/web/c', '/web/c', 1),
            ('/home/user/erpbizz/addons/web/e', '/web/e', 1),
        ], 'bundle3', 3)
        self.assertEqual(asset_paths.list, [
            ('/home/user/erpbizz/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/erpbizz/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'd' before 'd'
        asset_paths.insert([
            ('/home/user/erpbizz/addons/web/b', '/web/b', 1),
            ('/home/user/erpbizz/addons/web/d', '/web/d', 1),
        ], 'bundle4', 1)
        self.assertEqual(asset_paths.list, [

            ('/home/user/erpbizz/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/b', '/web/b', 'bundle4', 1),
            ('/home/user/erpbizz/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/erpbizz/addons/web/f', '/web/f', 'bundle2', 1),
        ...
        asset_paths.remove([
            ('/home/user/erpbizz/addons/web/c', '/web/c', 1),
            ('/home/user/erpbizz/addons/web/d', '/web/d', 1),
            ('/home/user/erpbizz/addons/web/g', '/web/g', 1),
        ], 'bundle5')
        self.assertEqual(asset_paths.list, [
            ('/home/user/erpbizz/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/erpbizz/addons/web/b', '/web/b', 'bundle4', 1),
...
class TestErrorManagement(HttpCase):
    ...
    def test_assets_bundle_css_error_backend(self):
        ...
        with mute_logger('odoo.addons.base.models.assetsbundle'):
            self.start_tour('/erpbizz', 'css_error_tour', login='admin')
