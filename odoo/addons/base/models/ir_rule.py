...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # - odoo/addons/base/tests/test_orm.py (/home/dle/src/erpbizz/master-nochange-fp/erpbizz/addons/base/tests/test_orm.py)
        self.env.flush_all()
        self.env.registry.clear_cache()
        return res
    ...
    def _make_access_error(self, operation, records):
        ...
        if company_related:
            ...
            if suggested_companies and len(suggested_companies) != 1:
                resolution_info += _('\n\nNote: this might be a multi-company issue. Switching company may help - in ErpBizz, not in real life!')
