    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if vals.get('translate') and not isinstance(vals['translate'], str):
                _logger.warning("Deprecated since ErpBizz 19, ir.model.fields.translate becomes Selection, the value should be a string")
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement ErpBizz many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by ErpBizz
