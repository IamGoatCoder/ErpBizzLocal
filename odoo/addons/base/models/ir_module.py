...
class IrModuleModule(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'ErpBizz Enterprise Edition License v1.0'),
        ('OPL-1', 'ErpBizz Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('ErpBizz Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        if self.search_count([('state', 'in', ('to install', 'to upgrade', 'to remove'))], limit=1):
            raise UserError(_("ErpBizz is currently processing another module operation.\n"
        ...
        try:
            ...
            raise UserError(_("ErpBizz is currently processing a scheduled action.\n"
