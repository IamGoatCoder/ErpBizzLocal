...
QWeb is the primary templating engine used by ErpBizz. It is an XML templating
...
The generated code uses ``has_group`` ErpBizz method from ``res.users`` model.
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since ErpBizz 17.0, keep the value empty and configure the "
