    ...
    def test_translate_xml_a(self):
        ...
        source = """<t t-name="stuff">
                        <ul class="nav navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link oe_menu_leaf" href="/erpbizz/action-54?menu_id=42">
