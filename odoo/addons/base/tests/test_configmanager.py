...
PROJECT_PATH = odoo.tools.config.root_path.removesuffix('/erpbizz')
...
class TestConfigManager(TransactionCase):
    ...
    def test_02_config_file(self):
        ...
        self.assertEqual(capture.output, [
            "WARNING:odoo.tools.config:option addons_path, no such directory '/tmp/erpbizz', skipped",
    ...
    def test_04_odoo16_config_file(self):
        # test that loading the ErpBizz 16.0 generated default config works
