...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(
        ...
        help="You can choose different models for each type of reference. The default one is the ErpBizz reference.",
    )
    ...
    inbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Get paid by any method outside of ErpBizz.\n"
    ...
    outbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Pay by any method outside of ErpBizz.\n"
        "Check: Pay bills by check and print it from ErpBizz.\n"
    ...
    alias_name = fields.Char(help="Send one separate email for each invoice.\n"
                                  ...
                                  "Only PDF and XML files will be interpreted by ErpBizz")
