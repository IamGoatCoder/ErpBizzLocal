...
class Database(http.Controller):
    ...
    @http.route(['/web/database/selector', '/erpbizz/database/selector'], type='http', auth="none")
    def selector(self, **kw):
        if request.db:
            request.env.cr.close()
        return self._render_template(manage=False)

    @http.route(['/web/database/manager', '/erpbizz/database/manager'], type='http', auth="none")
    def manager(self, **kw):
        if request.db:
            request.env.cr.close()
    ...
    def create(self, master_pwd, name, lang, password, **post):
        ...
        try:
            ...
            return request.redirect('/erpbizz')
