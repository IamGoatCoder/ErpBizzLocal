...
class AuthSignupHome(Home):
    ...
    def web_login(self, *args, **kw):
        ...
        if request.session.uid:
            ...
            if response.location == '/erpbizz/login_successful' and kw.get('confirm_password'):
                return request.redirect_query('/erpbizz/login_successful', query={'account_created': True})
        return response

    @http.route(['/web/signup', '/erpbizz/signup'], type='http', auth='public', website=True, sitemap=False, captcha='signup', list_as_website_content=_lt("Sign Up"))
    def web_auth_signup(self, *args, **kw):
        ...
        if 'error' not in qcontext and request.httprequest.method == 'POST':
            ...
            if user:
                return request.redirect('/erpbizz/login?%s' % url_encode({'login': user.login, 'redirect': '/erpbizz'}))
    ...
    @http.route(['/web/reset_password', '/erpbizz/reset_password'], type='http', auth='public', website=True, sitemap=False, captcha='password_reset', list_as_website_content=_lt("Reset Password"))
