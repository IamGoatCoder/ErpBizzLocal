...
describe("link preview", () => {
    ...
    test("test external link preview", async () => {
        onRpc("/html_editor/link_preview_external", () => ({
            og_description:
                "From ERP to CRM, eCommerce and CMS. Download ErpBizz or use it in the cloud. Grow Your Business.",
            og_image: "https://www.odoo.com/web/image/41207129-1abe7a15/homepage-seo.png",
            og_title: "Open Source ERP and CRM | ErpBizz",
            og_type: "website",
            og_site_name: "ErpBizz",
        ...
        expect(".o_we_url_link").toHaveText("Open Source ERP and CRM | ErpBizz");
    ...
    test("test external metadata cached correctly", async () => {
        const title = "Open Source ERP and CRM | ErpBizz";
        const description =
            "From ERP to CRM, eCommerce and CMS. Download ErpBizz or use it in the cloud. Grow Your Business.";
        onRpc("/html_editor/link_preview_external", () => {
