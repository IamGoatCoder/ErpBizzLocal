...
class WebTourHttp(HttpCase):
    ...
    def test_sanity_automatic(self):
        ...
        """
        self.browser_js("/erpbizz?debug=tests", code, ready=ready, login="admin")
    ...
    def test_sanity_onboarding(self):
        ...
        # We want to boot ErpBizz as in real life (not loading assets for tests)
        ...
        """
        self.browser_js("/erpbizz?debug=0", code, ready=ready, login="admin")
        if "website" in IrAsset._get_installed_addons_list():
