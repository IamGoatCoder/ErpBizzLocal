...
This is another: <a href="{self.base_url}/erpbizz?debug=1&more=2">{self.base_url}</a><br/>
...
And a 6th: <a href="/erpbizz">Here2</a><br>
And a 7th: <a href="{self.base_url}/erpbizz">Here2</a><br>
...
And a last, more complex: <a href="{self.base_url}/r/(\w+)">There!</a>
    ...
    def test_shorten_links_html_skip_shorts(self):
        ...
        new_content = self.env["mail.render.mixin"]._shorten_links(
            f'Reusing this old <a href="{created_short_url}">link</a> with a new <a href="https://erpbizz.com">one</a>', {}
        )
        expected = re.compile(
...
This is another: {self.base_url}/erpbizz?debug=1&more=2
...
And a last, with question mark: {self.base_url}/r/(\w+)"""
    ...
    def test_shorten_links_text_skip_shorts(self):
        ...
        new_content = self.env["mail.render.mixin"]._shorten_links_text(
            f'Reusing this old link {created_short_url} with a new one, https://erpbizz.com</a>', {}
        )
