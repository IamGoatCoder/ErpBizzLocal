...
class TestLinkTracker(common.TransactionCase, MockLinkTracker):
    ...
    def test_absolute_url(self):
        ...
        self.assertEqual(link_tracker.absolute_url, f'{self._web_base_url}/erpbizz')
    ...
    def test_create(self):
        ...
        self.assertEqual(
            ...
            ['http://erpbizz.com', 'http://example.com', 'http://test.example.com'],
        )
    ...
    def test_search_or_create(self):
        values_1, values_2, values_3 = [
            {'url': 'https://erpbizz.com', 'title': 'Odoo'},
            {'url': 'https://erpbizz.be', 'title': 'Odoo'},
            {'url': 'https://erpbizz.com', 'title': 'Odoo New', 'label': 'New one!'}  # title is not in unique constraint
        ]
        ...
        values_4 = {'url': 'https://erpbizz.com', 'label': 'A different one'}
        ...
        values_5 = {'url': 'https://erpbizz.com', 'label': 'Yet another label'}
        expected_values_5 = {
            'campaign_id': self.env['utm.campaign'],
