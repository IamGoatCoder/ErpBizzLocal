...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ("http://localhost:8069/", "http://localhost:8069/erpbizz", 0),
                ("http://localhost:8069/", "http://localhost:8069/erpbizz/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/web/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/", 1),
                ("http://localhost:8069/", "http://localhost:8069/erpbizz-experience", 1),
                ("http://localhost:8069/", "http://localhost:8069/chat/5/bFtIfYHRco", 0),
                ("https://www.odoo.com/", "https://www.odoo.com/web", 0),
                ("https://www.odoo.com/", "https://www.odoo.com/erpbizz", 0),
                ("https://www.odoo.com/", "https://www.odoo.com/erpbizz/", 0),
                ("https://www.odoo.com/", "https://www.odoo.com/erpbizz?debug=assets", 0),
                ("https://www.odoo.com/", "https://www.odoo.com/erpbizz#anchor", 0),
                ("https://www.odoo.com/", "https://www.odoo.com/erpbizz-experience", 1),
                ("https://www.odoo.com/", "https://www.odoo.com/erpbizz/1519/tasks/4102866", 0),
                ("http://www.odoo.com/", "https://www.odoo.com/erpbizz/1519/tasks/4102866", 1),
                ("https://www.odoo.com/", "https://wwwaodoo.com/erpbizz/", 1),
                ...
                ("https://clients.odoo.com/", "https://www.odoo.com/erpbizz/1519/tasks/4102866", 1),
    ...
    def test_remove_unused_link_preview(self):
        with (
            ...
            message = self.test_partner.message_post(
                body=Markup(
                    '<a href="https://www.odoo.com/erpbizz-experience">Nothing link</a> <a href="https://www.odoo.com/erpbizz-experience-2025">Other Nothing link</a>'
                ),
            ...
            self.test_partner._message_update_content(
                message,
                body=Markup('<a href="https://www.odoo.com/erpbizz-experience">Nothing link</a>'),
            )
            self.env["mail.link.preview"]._create_from_message_and_notify(message)
            link_preview_count = self.env["mail.message.link.preview"].search_count(
                [("message_id", "=", message.id)]
