...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_mail_tour(self):
        self.start_tour("/erpbizz", 'discuss_channel_tour', login="admin")
    ...
    def test_02_mail_create_channel_no_mail_tour(self):
        ...
        self.start_tour("/erpbizz", 'discuss_channel_tour', login='testuser')

    # basic rendering test of the configuration menu in Discuss
    def test_03_mail_discuss_configuration_tour(self):
        self.start_tour("/erpbizz", "discuss_configuration_tour", login="admin")
    ...
    def test_04_meeting_view_tour(self):
        ...
        self.start_tour(
            f"/erpbizz/discuss?active_id=discuss.channel_{group_chat.id}&fullscreen=1",
