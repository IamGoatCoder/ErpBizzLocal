...
class FetchmailServer(models.Model):
    ...
    script = fields.Char(readonly=True, default='/mail/static/scripts/erpbizz-mailgate.py')
...
/etc/aliases:
odoo_mailgate: "|/path/to/erpbizz-mailgate.py --host=localhost -u %(uid)d -p PASSWORD -d %(dbname)s"
        """ % conf
