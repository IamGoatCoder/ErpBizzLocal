...
# like:
#
# email@address: "|/home/erpbizz/src/erpbizz-mail.py"
#
# while exim uses a syntax that looks like:
#
# *: |/home/erpbizz/src/erpbizz-mail.py
...
def main():
    ...
    op.add_option("-d", "--database", dest="database", help="ErpBizz database name (default: %default)", default='odoo')
    op.add_option("-u", "--userid", dest="userid", help="ErpBizz user id to connect with (default: %default)", default=1, type=int)
    op.add_option("-p", "--password", dest="password", help="ErpBizz user password (default: %default)", default='admin')
    op.add_option("--host", dest="host", help="ErpBizz host (default: %default)", default='localhost')
    op.add_option("--port", dest="port", help="ErpBizz port (default: %default)", default=8069, type=int)
