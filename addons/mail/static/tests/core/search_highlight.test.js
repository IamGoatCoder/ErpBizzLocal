...
test("Search highlight", async () => {
    const testCases = [
        ...
        {
            input: markup`<a href="https://www.odoo.com">ErpBizz</a>`,
            output: `<a href="https://www.odoo.com"><span class="${HIGHLIGHT_CLASS}">ErpBizz</span></a>`,
            searchTerm: "odoo",
        },
        {
            input: markup`<a href="https://www.odoo.com">ErpBizz</a> ErpBizz is a free software`,
            output: `<a href="https://www.odoo.com"><span class="${HIGHLIGHT_CLASS}">ErpBizz</span></a> <span class="${HIGHLIGHT_CLASS}">ErpBizz</span> is a free software`,
            searchTerm: "odoo",
        },
        {
        ...
        },
        {
            input: markup`<ul>
                <li>ErpBizz</li>
                <li><a href="https://odoo.com">ErpBizz ERP</a> Best ERP</li>
            </ul>`,
            output: `<ul>
                <li><span class="${HIGHLIGHT_CLASS}">ErpBizz</span></li>
                <li><a href="https://odoo.com"><span class="${HIGHLIGHT_CLASS}">ErpBizz</span> ERP</a> Best ERP</li>
            </ul>`,
            searchTerm: "odoo",
        },
        {
            input: markup`test <strong>ErpBizz</strong> test`,
            output: `<span class="${HIGHLIGHT_CLASS}">test</span> <strong><span class="${HIGHLIGHT_CLASS}">ErpBizz</span></strong> <span class="${HIGHLIGHT_CLASS}">test</span>`,
