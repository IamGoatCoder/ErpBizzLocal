...
export class Homepage extends Component {
    ...
    async restartOdooService() {
        try {
            ...
            console.warn("Error while restarting ErpBizz Service");
        }
    }
    ...
    <t t-translation="off">
        ...
        <div t-if="!this.state.loading" class="w-100 d-flex flex-column align-items-center justify-content-center background">
            <div class="bg-white p-4 rounded overflow-auto position-relative w-100 main-container">
                ...
                <SingleData t-if="!store.base.is_access_point_up" name="'ErpBizz database connected'" value="state.data.server_status" icon="'fa-link'">
                    <t t-set-slot="button">
                        <ServerDialog />
                    </t>
                </SingleData>
                <SingleData t-if="state.data.pairing_code and !this.store.base.is_access_point_up and !state.data.pairing_code_expired" name="'Pairing Code'" value="state.data.pairing_code + ' - Enter this code in the IoT app in your ErpBizz database'" icon="'fa-code'"/>
