...
# Download and extract Raspberry Pi OS, ngrok and clone ErpBizz repository
...
mkdir -pv ./.ssh
echo "y" | ssh-keygen -t ed25519 -f "./.ssh/iotbox_ca_${VERSION_IOTBOX}" -N "" -C "ErpBizz SSH CA ${VERSION_IOTBOX}"
